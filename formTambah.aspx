<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="formTambah.aspx.vb" Inherits="formTambah" %>
                ...
                <!-- Nested Row within Card Body -->
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Tambah Barang Toko</h1>
                        </div>
                        ...
                        <asp:Button ID="Button1" class="btn btn-primary btn-user btn-block" runat="server" Text="Tambah Barang" />
                        <hr>
                    </div>
                </div>
        </div>
